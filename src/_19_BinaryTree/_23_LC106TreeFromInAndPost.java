...
public class _23_LC106TreeFromInAndPost {
    ...
    class Solution {
        ...
        public TreeNode build(int inLow, int inHigh, int postLow, int postHigh, int[] inorder, int[] postorder){
            ...
            int count = idx - inLow;
            root.left = build(inLow, idx-1, postLow, postLow+count-1, inorder, postorder);
            root.right = build(idx+1, inHigh, postLow+count, postHigh-1, inorder, postorder);
            return root;
        }
        // main function
